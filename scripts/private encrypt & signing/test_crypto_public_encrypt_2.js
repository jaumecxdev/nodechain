...
// Using a function generateKeyFiles
	...
	//fs.writeFileSync("public_key333", keyPair.publicKey);
	//fs.writeFileSync("private_key333", keyPair.privateKey);
...
function encryptString(plaintext, publicKeyFile) {
	...
	const encrypted = crypto.publicEncrypt(
		keyPair.publicKey, Buffer.from(plaintext));
...
const encrypted = encryptString(plainText, "./public_key333");
...
console.log("Decrypted Text: ",
	decryptString(encrypted, "private_key333"));
